 ...
 * Author: Kripa Maria
 * Date: July 2026
 * Description: Multi-sensor formatted metrics logging array script.
 *****************************************************************************/
#include <DHT.h>
...
void loop() {
  delay(5000); // Enforce strict 5-second datalogging rhythm constraints
  ...
  Serial.print("Light     : "); Serial.print(lightPct); Serial.println(lightPct > 65 ? "% (Bright)" : "% (Dark)");
